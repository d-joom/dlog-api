...
import com.dlog.api.user.repository.UserBlogRepository;
import com.dlog.api.user.service.UserBlogService;
...
public class UserBlogController {
	...
	public ListResult<UserBlog> getUserBlogs(@RequestHeader(required = true, defaultValue = "Bearer TOKEN_VALUE") String token,
            ...
            @RequestParam(required = false) String deacription,
        ...
        if (deacription != null) {
			searchKeyword.put("deacription", deacription);
        }
        if (theme != null) {
